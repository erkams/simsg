...
# MODIFIED FOR GENERATIONS IN DOCKER VOGETE/BLENDER-CUDA
...
echo $start
"$blender_path"/blender --background --python render_clevr.py -- --num_images 1200 --output_image_dir "$out_folder/images/" --output_scene_dir "$out_folder/scenes/" --output_scene_file "$out_folder/CLEVR_scenes.json" --max_objects 7 --min_objects 2 --start_idx $start --use_gpu 1 --mode "$mode"
done
